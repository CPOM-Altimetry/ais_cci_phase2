...
<p>Each file contains the gridded cumulative annual surface elevation change since 1st Jan 1993, calculated from cross-calibrated 
  radar altimetry missions. 
  The <b>first file</b> shown is the cumulative dh from 01/01/1993 until the latest available month of data. Note that
  this may be a partial final year. 
The <b>second file</b>
  is a zip of all  netcdf files since 1993, stepped by 1 year, containing complete years only.</p>
<table class="downloads">
  <thead>
    <tr>
      <th style="width:10%">Mission</th>
