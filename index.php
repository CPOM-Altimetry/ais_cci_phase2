...
<body>
    ...
    <div class="tab">
        ...
        <button class="tablinks" <?php if ($show_single_mission) echo 'id="defaultOpen"'; ?> onclick="openTab(event, 'single_mission')">Single RA Mission SEC</button>
        <button class="tablinks" onclick="openTab(event, 'is2_sec')">ICESat-2 SEC</button>
        <button class="tablinks" onclick="openTab(event, 'multi_mission')">Multi-Mission RA SEC</button>
        <button class="tablinks" onclick="openTab(event, 'annual_dh')">Annual dH</button>
